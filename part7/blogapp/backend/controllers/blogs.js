...
router.post('/:id/comments', async (request, response) => {
    ...
    const commentedBlog = await Blog.findByIdAndUpdate(blogId, { comments: [...blogToComment.comments].concat(newComment) }, { new: true }).populate('user', { username: 1, name: 1, id: 1 })
